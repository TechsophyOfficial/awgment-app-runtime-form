...
class FormDataAuditServiceImplExceptionTest
{
    @Mock
    ...
    @Test
    void saveFormDataInvalidInputExceptionTest() throws JsonProcessingException
    {
        ...
        FormDataAuditSchema formDataAuditSchemaTest = new FormDataAuditSchema(TEST_ID,TEST_FORM_DATA_ID,EMPTY_STRING, TEST_VERSION, testFormData, testFormMetaData);
        Assertions.assertThrows(InvalidInputException.class, () ->
                mockFormDataAuditServiceImpl.saveFormDataAudit(formDataAuditSchemaTest));
    }

    @Test
    void getAllFormDataByFormIdDocumentIdFormIdNotFoundExceptionTest()
    {
        Map<String, Object> testFormMetaData = new HashMap<>();
        testFormMetaData.put(FORM_VERSION, 1);
        Map<String, Object> testFormData = new HashMap<>();
        ...
        Mockito.when(mockMongoTemplate.collectionExists(TP_RUNTIME_FORM_DATA +formDataAuditSchemaTest.getFormId()+AUDIT)).thenReturn(false);
    ...
    @Test
    void getAllFormDataByFormIdDocumentIdCatchExceptionTest()
    {
        Map<String, Object> testFormMetaData = new HashMap<>();
        testFormMetaData.put(FORM_VERSION, 1);
        Map<String, Object> testFormData = new HashMap<>();
        ...
        Mockito.when(mockMongoTemplate.getCollection(TP_RUNTIME_FORM_DATA +formDataAuditSchemaTest.getFormId()+AUDIT)).thenReturn(null);
        Assertions.assertThrows(FormIdNotFoundException.class,() ->
                mockFormDataAuditServiceImpl.getAllFormDataAuditByFormIdAndDocumentId(TEST_FORM_ID,TEST_ID));
    }
}
